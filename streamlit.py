...
# Load components
loo_preprocessor = joblib.load("loo_encoder.pkl")
...
if submitted:
    ...
    # 5. Apply Leave-One-Out encoding
    ...
    final_input = pd.concat([
        ...
        pd.DataFrame(loo_encoded, columns=loo_preprocessor.get_feature_names_out(), index=full_input.index)
    ], axis=1)
